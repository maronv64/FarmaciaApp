...
//   }
// ];
let MiscomprasItemModalPageModule = class MiscomprasItemModalPageModule {
};
...
let MiscomprasItemModalPage = class MiscomprasItemModalPage {
    constructor(modalController, comprasService, alertController) {
                ...
                buttons: [
                    {
                        ...
                        handler: () => {
                            ...
                            this.nome_token_user = localStorage.getItem('miCuenta.nome_token');
                            this.comprasService.finalizar_venta(this.nome_token_user, _item).subscribe(item => {
...
MiscomprasItemModalPage.ctorParameters = () => [
...
let MiscomprasPageModule = class MiscomprasPageModule {
};
...
let MiscomprasPage = class MiscomprasPage {
    constructor(comprasService, modalController, alertController, router, platform) {
        this.comprasService = comprasService;
        this.modalController = modalController;
        this.alertController = alertController;
        this.router = router;
                ...
                buttons: [
                    ...
                    },
                    {
                        ...
                        handler: () => {
                            // =================Eliminar========================
                            this.nome_token_user = localStorage.getItem('miCuenta.nome_token');
                            this.comprasService.delete(this.nome_token_user, _item).subscribe(item => {
                                this.filtro("");
                            }, error => {
                                this.ListaCompras.closeSlidingItems();
                            });
...
let ComprasService = class ComprasService {
    ...
    delete(_nome_token_user, _request) {
...
//# sourceMappingURL=pages-miscompras-miscompras-module-es2015.js.map