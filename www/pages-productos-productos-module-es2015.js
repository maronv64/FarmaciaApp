...
//   }
// ];
let ProductosItemModalPageModule = class ProductosItemModalPageModule {
};
...
let ProductosItemModalPage = class ProductosItemModalPage {
    constructor(modalController, alertController, carritoService) {
...
ProductosItemModalPage.ctorParameters = () => [
...
let ProductosPage = class ProductosPage {
    constructor(productoService, router, modalController, loadingController) {
    ...
    filtro(_nome_token) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            this.productoService.filtro(this.nome_token_user, this._request).subscribe(item => {
...
let ProductoService = class ProductoService {
    ...
    show(_nome_token_user, _request) {
    ...
    filtro(_nome_token_user, _request) {
        let _params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpParams"]({
            fromObject: {
                'nome_token': _request.nome_token,
            }
...
//# sourceMappingURL=pages-productos-productos-module-es2015.js.map