...
var CarritoService = /** @class */ (function () {
    ...
    CarritoService.prototype.filtro = function (_nome_token_user, _value) {
        var _params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpParams"]({
            fromObject: {
                'value': _value,
            }
        });
        return this.http.get(this.apiUrl + "detalle_ventas_filtro/" + _nome_token_user + "/", { headers: this._headers, params: _params });
    };
    CarritoService.prototype.store = function (_nome_token_user, _request) {
        ...
        return this.http.post(this.apiUrl + "detalle_ventas_store/" + _nome_token_user + "/", _request, { headers: this._headers });
    };
    CarritoService.prototype.delete = function (_nome_token_user, _request) {
        ...
        return this.http.delete(this.apiUrl + "detalle_ventas_delete/" + _nome_token_user + "/", { headers: this._headers, params: _params });
        // let httpOptions={headers:this._headers,params:this._params};
    };
    CarritoService.prototype.generar_venta = function (_nome_token_user, _request) {
        return this.http.post(this.apiUrl + "ventas_store/" + _nome_token_user + "/", _request, { headers: this._headers });
    };
    CarritoService.prototype.generar_pedido = function (_nome_token_user, _request) {
        // return this.http.put()
        return this.http.put(this.apiUrl + "ventas_generar_pedido/" + _nome_token_user + "/", _request, { headers: this._headers });
    };
    CarritoService.ctorParameters = function () { return [
