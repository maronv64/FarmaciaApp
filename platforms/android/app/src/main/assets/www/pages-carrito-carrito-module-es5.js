...
//   }
// ];
var CarritoItemModalPageModule = /** @class */ (function () {
    function CarritoItemModalPageModule() {
    }
    ...
    return CarritoItemModalPageModule;
}());
...
var CarritoItemModalPage = /** @class */ (function () {
    function CarritoItemModalPage(modalController) {
        this.modalController = modalController;
        this.item = {};
    }
    CarritoItemModalPage.prototype.ngOnInit = function () {
    };
    CarritoItemModalPage.prototype.salir = function () {
    ...
    CarritoItemModalPage.ctorParameters = function () { return [
...
var CarritoPage = /** @class */ (function () {
    function CarritoPage(carritoService, alertController, modalController, loadingController, geolocation) {
    ...
    CarritoPage.prototype.ngOnInit = function () {
        this.filtro('');
    };
    CarritoPage.prototype.ngOnDestroy = function () {
        this.filtro('');
    };
    CarritoPage.prototype.filtro = function (_value) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var loading;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
    ...
    CarritoPage.prototype.eliminar = function (_item) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var alert;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                            ...
                            buttons: [
                                ...
                                },
                                {
                                    ...
                                    handler: function () {
                                        ...
                                        _this.carritoService.delete(_this.nome_token_user, _item)
                                            .subscribe(function (item) {
                                            console.log('hola');
                                            _this.filtro("");
                                        }, function (error) {
                                            console.log('error: ', error);
                                            _this.listaCarrito.closeSlidingItems();
                                        });
    ...
    CarritoPage.prototype.verModalUbicacion = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var modal, data;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
    ...
    CarritoPage.prototype.verItem = function (_item) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var modal;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
    ...
    CarritoPage.prototype.escojerUbicacion = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var alert;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                            ...
                            buttons: [
                                {
                                    ...
                                    handler: function (input) {
                                        ...
                                        if (input == "actual") {
                                            _this.guardarUBiActual();
                                        }
                                        else if (input == "nueva") {
                                            _this.verModalUbicacion();
    ...
    CarritoPage.prototype.generar_pedido2 = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var _venta;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                ...
                if (this._ubicacion != null) {
                    ...
                    this.carritoService.generar_venta(this.nome_token_user, _venta)
                        ...
                        _this.carritoService.generar_pedido(_this.nome_token_user, item.items)
                            .subscribe(function (item) {
    ...
    CarritoPage.prototype.generar_pedido = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var _venta, alert;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                                ...
                                buttons: [
                                    {
                                        ...
                                        handler: function () {
                                            ...
                                            _this.carritoService.generar_venta(_this.nome_token_user, _venta)
                                                .subscribe(function (item) {
                                                _venta = item.items;
                                                console.log('se genero la venta en cero', _venta.id);
                                                _this.carritoService.generar_pedido(_this.nome_token_user, item.items)
    ...
    CarritoPage.prototype.guardarUBiActual = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var myLatLog;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
    ...
    CarritoPage.prototype.getLocation = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var rta;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
    ...
    CarritoPage.ctorParameters = function () { return [
...
//   }
// ];
var UbicacionItemModalPageModule = /** @class */ (function () {
    function UbicacionItemModalPageModule() {
    }
    ...
    return UbicacionItemModalPageModule;
}());
...
var UbicacionItemModalPage = /** @class */ (function () {
    function UbicacionItemModalPage(geolocation, loadingController, alertController, modalController) {
        this.geolocation = geolocation;
        this.loadingController = loadingController;
        this.alertController = alertController;
        this.modalController = modalController;
    ...
    UbicacionItemModalPage.prototype.ngOnInit = function () {
        this.loadMap();
    };
    UbicacionItemModalPage.prototype.loadMap = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        mapEle = document.getElementById('map_modal');
    ...
    UbicacionItemModalPage.prototype.hola = function (lat, lng, google) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
    ...
    UbicacionItemModalPage.prototype.addMarker = function (lat, lng, google) {
        console.log(lat, lng);
        // var iconBase = {
    ...
    UbicacionItemModalPage.prototype.getLocation = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var rta;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
    ...
    UbicacionItemModalPage.prototype.guardarUBi = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
    ...
    UbicacionItemModalPage.prototype.salir = function () {
        this._ubicacion.latitud = null;
        this._ubicacion.longitud = null;
        this.modalController.dismiss(this._ubicacion);
    };
    UbicacionItemModalPage.ctorParameters = function () { return [
...
//# sourceMappingURL=pages-carrito-carrito-module-es5.js.map